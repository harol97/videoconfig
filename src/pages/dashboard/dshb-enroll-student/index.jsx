...
import StudentsTable from "@/components/dashboard/EnrollStudent/StudentsTable";

const metadata = {
  title:
    "Dashboard-dictionary || Tutrx - Professional LMS Online Education Course ReactJS Template",
  description:
