...
// 
export default function EditProfileTutor({ activeTab }) {
  ...
  const onSubmit = async (d) => {
    try {
      const { image, portfolio, twitter, linkedin, instagram } = d;
      // 
      dispatch.models.SET({
      ...
      // 
      if (portfolio || twitter || linkedin || instagram) {
        params = {
          ...params,
          socials: {
            portfolio,
      ...
      <div className="border-top-light pt-30 mt-30">
        <form onSubmit={handleSubmit(onSubmit)} className="contact-form row y-gap-30">
          ...
          <div className="col-md-6">
            ...
            <input type="text" placeholder="Portfolio" {...register('portfolio')} />
          </div>
          ...
          <div className="col-md-6">
            ...
            <input type="text" placeholder="Full Name" {...register('instagram')} />
          </div>
